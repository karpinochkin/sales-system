...
ApplicationWindow {
    ...
    title: qsTr("Sales Product Client")
    visible: true
    onClosing: {
    ...
    Connections {
        ...
        onSignalCategoryTabsCreated : {
            listTabs.append({ name: qmlProperty.categoryName,
                                categoryID: qmlProperty.categoryID,
                                categoryColor: qmlProperty.categoryColor
                            })
        }
        ...
        onSignalProductsListCreated : {
            listMenu.append({ name: qmlProperty.productName,
                                productID: qmlProperty.productID,
                                categoryID: qmlProperty.categoryID,
        ...
        onSignalGetSomePropertyForSoldPosition : {
            ...
            qmlProperty.idPaymentTypeForSoldPosition = orderListModel.get(index).idTypeProduct
    ...
    function totalSumOrder(){
        ...
        {
            rubels += orderListModel.get(i).rubles
        ...
        totalCost.text = rublesNal +" руб. "+ coinsNal +" коп."
        totalCost2.text = rublesBeznal +" руб. "+ coinsBeznal +" коп."
