...
//    radius: mainView.dp(15)
    ...
    Column {
        ...
        UpperMenuButton {
            ...
            scale: closeShiftButtonArea.pressed ? 0.9 : 1.0
        }
        ...
        UpperMenuButton {
            ...
            MouseArea {
                ...
                onClicked:{
                    ...
                    middlewareQML.fillReceipts()
                }
            }
            scale: reportButtonArea.pressed ? 0.9 : 1.0
        }
    }
    ...
    states: [
        ...
        State {
            ...
            PropertyChanges {
                ...
                y:boxButtonUpperMenu.y - boxButtonUpperMenu.height/3 - 50
            }
        }
    ]
    ...
    MessageDialog {
        ...
        onYes: {
            ...
            middlewareQML.disconnectFromHost()
