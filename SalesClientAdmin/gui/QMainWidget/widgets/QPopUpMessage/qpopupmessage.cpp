...
QPopUpMessage::QPopUpMessage(QChart *chart):
    QGraphicsItem(chart),
    m_chart(chart)
{
}

QRectF QPopUpMessage::boundingRect() const
{
...
void QPopUpMessage::paint(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *widget)
{
    Q_UNUSED(option)
    Q_UNUSED(widget)
    QPainterPath path;
...
void QPopUpMessage::mousePressEvent(QGraphicsSceneMouseEvent *event)
{
    event->setAccepted(true);
}

void QPopUpMessage::mouseMoveEvent(QGraphicsSceneMouseEvent *event)
{
...
void QPopUpMessage::setText(const QString &text)
{
    m_text = text;
...
void QPopUpMessage::setAnchor(QPointF point)
{
    m_anchor = point;
}

void QPopUpMessage::updateGeometry()
{
    prepareGeometryChange();
