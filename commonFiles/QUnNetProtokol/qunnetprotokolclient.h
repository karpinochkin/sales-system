...
public:
    ...
    bool flagClearOnDisconnect = false;
    ...
    void setNewPassword(QString login, QString Password);
...
private:
    ...
    void command06 (QByteArray data); //Результат изменения пароля
    QUNAccountInfo currentAccInfo;
...
signals:
    ...
    void signalResultSetNewPassword(bool result,QString login);
